...
def can_admin_access_result(admin_user: User, result: PFTResult, db: Session) -> bool:
    ...
    1. The result was created by an evaluator assigned to this admin
    2. OR the admin is a super_admin (handled separately)
    """
    if admin_user.role == "super_admin":
        return True

    # Find the evaluator who created this result
...
async def get_all_pft_results(
    ...
    try:
        if current_user.role == "super_admin":
            ...
            # Get IDs of evaluators assigned to this admin
            ...
            if not assigned_evaluator_ids:
                return []  # No assigned evaluators, return empty
