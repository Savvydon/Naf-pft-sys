...
# #     # Add to backend/app/services/models.py
...
# #     # Link to PFT Result
# #     pft_result_id = Column(Integer, ForeignKey("pft_results.id"), unique=True, nullable=False)
# #     pft_result = relationship("PFTResult", backref="certificate")
    
# #     # Certificate Details
# #     certificate_number = Column(String(20), unique=True, nullable=False, index=True)
# #     rank_and_name = Column(String(200), nullable=False)
# #     svc_no = Column(String(50), nullable=False, index=True)
# #     unit = Column(String(100), nullable=False)
# #     participated_in = Column(String(255), nullable=False)
# #     confirmed = Column(String(20), nullable=False)  # "Fit", "Not Fit", "Excused"
...
# #     # Issuer Info
# #     issued_by = Column(String(100), nullable=False)  # Admin/SuperAdmin name
# #     issued_by_rank = Column(String(50), nullable=True)
...
# #     def __repr__(self):
# #         return f"<Certificate {self.certificate_number} for {self.svc_no}>"
