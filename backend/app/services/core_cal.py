...
#     # --- Higher is better (Strength & endurance) ---
#     ideal = cfg["ideal"]
...
#     if cfg["type"] == "Closer to ideal":
#         low, high = ideal
#         deficit = max(0, low - value)
#         excess = max(0, value - high)
...
#         duration, days = "Maintain routine", "Maintain routine"
#         activity = (
#             "Maintain your fitness routine: Golf, Volleyball, Weight Training."
#         )
#     elif aggregate >= 75:
#         grade = "Good"
#         duration, days = "1–35 minutes", "3–4 days per week"
#         activity = (
#             "Moderate aerobic activities: Tennis (single), aerobic dance, fast walking."
#         )
#     elif aggregate >= 70:
#         grade = "Marginal"
#         duration, days = "36–45 minutes", "3–4 days per week"
#         activity = (
#             "Strenuous activities: Basketball, soccer, circuit training, hill climbing."
#         )
#     else:
#         grade = "Poor"
#         duration, days = "46 minutes and above", "5–6 days per week"
#         activity = (
#             "Strenuous aerobic activities: Jogging, running, swimming, rope skipping."
#         )
