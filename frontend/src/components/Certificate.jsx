  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(input, {
        scale: 2,
        useCORS: true,
        backgroundColor: "#FAF9F6", // Match the cream background
        width: 850,
      ...
      pdf.save(`NAF_PFT_Certificate_${result?.svc_no || "PERSONNEL"}_${certNumber}.pdf`);
    } finally {
      // Restore styles
    ...
    <div className="certificate-page">
      ...
      <div className="certificate-form">
        ...
        <div className="form-group">
          ...
          <input type="text" value={`NAF/786/HQ${certNumber}`} readOnly className="readonly" />
        </div>
        ...
        <div className="form-actions">
          ...
          <button onClick={generatePDF} className="btn pdf-btn">Download PDF</button>
          <button onClick={sendCertificate} className="btn email-btn" disabled={isSending}>
        ...
        <div ref={certRef} className="certificate-wrapper">
          ...
          <div className="watermark-layer">
            {watermarkArray.map((_, index) => (
              <div key={index} className="watermark-text">NIGERIAN AIR FORCE</div>
            ))}
          </div>
          ...
          <div className="certificate-content">
            ...
            <div className="cert-number-section">
              <div className="cert-number-full">NAF/786/HQ<span className="cert-num-value">{certNumber}</span></div>
              <div className="cert-number-note">(To identify the Comds/053 NAF CAMP)</div>
            </div>
            ...
            {/* Title */}
            <h1 className="cert-main-title">NAF PHYSICAL FITNESS TEST CERTIFICATE</h1>
            ...
            <div className="cert-fields">
              ...
              <div className="cert-row three-cols">
                <div className="cert-field">
                  ...
                  <span className="field-line">{rankAndName || "_______________________"}</span>
                </div>
                <div className="cert-field">
                  <span className="field-label">Svc No.</span>
                  <span className="field-line">{result.svc_no || "_______________________"}</span>
                </div>
                <div className="cert-field">
                  <span className="field-label">Unit</span>
                  <span className="field-line">{result.unit || "_______________________"}</span>
                </div>
              </div>
              ...
              <div className="cert-row issued-row">
                <span className="issued-text">
                  Issued on <span className="issued-line">{issuedDay || "__________"}</span> day of <span className="issued-line">{issuedMonth || "__________"}</span> 20<span className="issued-line">{issuedYear || "____"}</span>
                </span>
              </div>
            </div>
